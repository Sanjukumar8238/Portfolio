  ...
  return (
    ...
    >
      <div className={`${styles.paddingX} absolute inset-0 top-[90px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className=" text-[#915eff]">Sanju</span></h1>
      ...
      <div className=" absolute xs:bottom-3 bottom-32 w-full flex justify-center items-center scale-75">
        <a href="#about">
